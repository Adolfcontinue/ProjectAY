...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AClientPlayerController_Statics::NewProp_ShortPressThreshold = { "ShortPressThreshold", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AClientPlayerController, ShortPressThreshold), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AClientPlayerController_Statics::NewProp_ShortPressThreshold_MetaData), Z_Construct_UClass_AClientPlayerController_Statics::NewProp_ShortPressThreshold_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AClientPlayerController_Statics::NewProp_FXCursor = { "FXCursor", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AClientPlayerController, FXCursor), Z_Construct_UClass_UNiagaraSystem_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AClientPlayerController_Statics::NewProp_FXCursor_MetaData), Z_Construct_UClass_AClientPlayerController_Statics::NewProp_FXCursor_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AClientPlayerController_Statics::NewProp_DefaultMappingContext = { "DefaultMappingContext", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AClientPlayerController, DefaultMappingContext), Z_Construct_UClass_UInputMappingContext_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AClientPlayerController_Statics::NewProp_DefaultMappingContext_MetaData), Z_Construct_UClass_AClientPlayerController_Statics::NewProp_DefaultMappingContext_MetaData) };
#if WITH_METADATA
	...
	struct Z_CompiledInDeferFile_FID_Users_godye_Desktop_Project_ProjectAY_Client_Source_Client_ClientPlayerController_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_godye_Desktop_Project_ProjectAY_Client_Source_Client_ClientPlayerController_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AClientPlayerController, AClientPlayerController::StaticClass, TEXT("AClientPlayerController"), &Z_Registration_Info_UClass_AClientPlayerController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AClientPlayerController), 377566004U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_godye_Desktop_Project_ProjectAY_Client_Source_Client_ClientPlayerController_h_2955129990(TEXT("/Script/Client"),
		Z_CompiledInDeferFile_FID_Users_godye_Desktop_Project_ProjectAY_Client_Source_Client_ClientPlayerController_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_godye_Desktop_Project_ProjectAY_Client_Source_Client_ClientPlayerController_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
